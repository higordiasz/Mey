...
module.exports = {
    ...
    async execute(message, args, client) {
        ...
        let relacionamento = !db.fetch(`user.${user.user.id}.namoro`) ? 'Solteiro' : db.get(`user.${user.user.id}.namoro`)
        if (relacionamento != 'Solteiro') {
            relacionamento = await client.users.fetch(relacionamento)
        }
